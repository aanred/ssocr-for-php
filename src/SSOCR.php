...
class SSOCR
{
     ...
     * 
     * @param  integer $threshold Threshold in percentage
     * @return this
     */
     ...
     * 
     * @param  integer $x Upper left corner X
     * @param  integer $y Upper left corner Y
     ...
     * 
     * @param  integer $numberDigits Number of digits
     * @return this
     */
